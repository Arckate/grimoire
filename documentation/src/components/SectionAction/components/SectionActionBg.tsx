...
interface SectionActionBgProps {
	paths: Paths[];
	density?: number;
	scale?: number;
	width?: string;
...
const SectionActionBg: React.FC = ({
	paths,
	density = 20,
	scale = 0.6,
	width = "100%",
	height = "100%",
}: SectionActionBgProps) => {
	...
	return (
		<div ref={containerRef} className="background" style={{ width, height }}>
...
export default SectionActionBg;
