...
describe("startCli", () => {
	...
	it("should fallback to empty commands object if config.commands is undefined", async () => {
		...
		await startCliFactory(defaultDir, mockOldConfig)(mockConfig as any, testDir);
	...
	it("should pass config.dirnamesFile when defined", async () => {
		...
		await startCliFactory(defaultDir, mockOldConfig)({ ...mockConfig, dirnamesFile: customFile }, testDir);
	...
	it("should fallback to DIRNAMES_FILE when config.dirnamesFile is undefined", async () => {
		...
		await startCliFactory(defaultDir, mockOldConfig)(configWithoutDirnamesFile, testDir);
