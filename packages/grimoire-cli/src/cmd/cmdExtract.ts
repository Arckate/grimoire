import { mergeExtractsConfig, findSkippedParams, findArgs, cmdPlop } from "@arckate/grimoire-core/cmd";
import { setDirs, setExtracts } from "@arckate/grimoire-core/config";
import { INIT_PLOP_FILE, CONF_EXTRACTS, DIRS } from "@arckate/grimoire-core/const";
import { CmdFn, ExtractsConfig } from "@arckate/grimoire-core/entities";
